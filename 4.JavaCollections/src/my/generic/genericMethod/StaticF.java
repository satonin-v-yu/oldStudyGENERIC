package my.generic.genericMethod;
...
class ClazzStatic2F2<T> { //03
    public static<T2> T2 someStaticMethod(T2 /*T2*/ genericObject) {
        System.out.println(genericObject);
        return genericObject;
    }
//   (i thinked 5 sec) NOT WORK other small problem (clear type)
//    public T someStaticMethod(T /*T2*/ genericObject) {
//        System.out.println(genericObject);
//        return genericObject;
//    }
    public T someMethod(T /*T2*/ genericObject) {
        System.out.println(genericObject);
        return genericObject;
    }
}

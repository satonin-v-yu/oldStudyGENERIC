package my.generic.UriyTkach.bounded3ver;
...
public abstract class Product<T extends Product<T>> implements Comparable<T>{ //Рекусивное расширение типа//Т can init ONLY PARENT
    double price;
